...
!!! note "Usage within the PROTEUS framework"
    ZEPHYRUS is most commonly installed and used as integrated into the PROTEUS framework. Understand how to use PROTEUS [here](https://proteus-framework.org/PROTEUS). 
