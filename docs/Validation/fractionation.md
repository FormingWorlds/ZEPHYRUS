...
| `tests/test_fractionation.py::test_hunten_anchors_earth_mars_venus` | Hunten, Pepin & Walker (1987), Icarus 69, 532 (worked Earth, Mars, and Venus anchors) | The printed numerical anchors are reproduced from the threshold relation and through the solver's own activation threshold within 1 percent. |
