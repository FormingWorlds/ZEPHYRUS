...
The Eq. (10) scaling rule is validated in sample on the three atomic rows the 2023 authors themselves obtained by scaling, and out of sample on the Kr and Xe rows of the 1986 table (which are not sources of this library), landing inside the 30 percent scaled provenance class in natural log.
