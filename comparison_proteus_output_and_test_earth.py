...
vectorized_Fxuv = np.vectorize(XUV_flux.Fxuv_Ribas2005)
...
for i in sorted_files:
    integrated_xuv_flux, time_step, integrated_all_flux, all_wavelength, all_flux, xuv_wavelength, xuv_flux = open_flux_files('data/XUV_tracks_from_proteus/'+i) 
