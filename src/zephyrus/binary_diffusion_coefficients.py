...
Binary diffusion coefficients for different gas mixtures.
'''

##################### H as a background gas ######################

#### Fractionation with atomic species ####

def b_H_H(T):
    '''
    Binary diffusion coefficient for H in H [atoms/m/s] from Weissman and Masson 1962
    '''
...
def b_H_O(T):
    '''
    Binary diffusion coefficient for O in H [atoms/m/s] from Wordsworth et al. 2018
    '''
    b_HO = 4.8e19*T**0.75
    return b_HO
...
def b_H_C(T):
    '''
    Binary diffusion coefficient for C in H [atoms/m/s] approximated from b_H_O using Genda, Ikoma 2008 formulation of Equation C3 in Appendix C
    '''
    b_HC = 4.85e19*T**0.75
    return b_HC
...
def b_H_N(T):
    '''
    Binary diffusion coefficient for N in H [atoms/m/s]approximated from b_H_O using Genda, Ikoma 2008 formulation of Equation C3 in Appendix C
    '''
    b_HN = 4.85e19*T**0.75
    return b_HN
...
def b_H_S(T):   
    '''
    Binary diffusion coefficient for S in H [atoms/m/s] approximated from b_H_O using Genda, Ikoma 2008 formulation of Equation C3 in Appendix C
    '''
    b_HS = 4.73e19*T**0.75
    return b_HS
