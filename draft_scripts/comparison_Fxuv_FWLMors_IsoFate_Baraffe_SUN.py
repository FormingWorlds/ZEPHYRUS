...
sys.path.extend([mors_dir, constants_dir, planets_parameters_dir, xuv_flux_dir, fxuv_functions_dir])
import mors
from constants import *
from planets_parameters import *
from XUV_flux import *
from Fxuv_functions import read_flux_data
    
########################### Path to directories ###############################

mors_data_dir                   = '/Users/emmapostolec/Documents/PHD/SCIENCE/CODES/ZEPHYRUS/data/Fxuv_tracks/Mors_stellar_evolution_tracks/'
...
## Loading the Fxuv tracks from MORS using mors.Star() or mors.Lxuv() to extract Fxuv
filename_Lxuv           = 'Lxuv_vs_age_Star_1.0Msun_Omega_1.0.txt'        # mors.Lxuv() function
filepath_Lxuv           = os.path.join(mors_data_dir, filename_Lxuv)
Lxuv_age, Lxuv_lxuv     = read_flux_data(filepath_Lxuv)
Lxuv_Fxuv               = Lxuv_lxuv/(4*np.pi*(a_earth*au2cm)**2)
filename_Star           = 'Star_1.0Msun_Myr_Omega_1.0.pickle'             # mors.Star() class
filepath_Star           = os.path.join(mors_data_dir, filename_Star)
...
## Fxuv from Johnstone+2021 file : 1.0 Msun, OmegaSun = 1.0
...
## Fxuv from a PROTEUS simulation for Sun-Earth system using Mors tracks 
