...
for mass, color, label in zip(masses, colors, labels):
    ...
    plt.loglog(star.Tracks['Age'], star.Tracks['Leuv'], color=color, label=label)

# Add labels, legend, and grid
plt.ylabel(r'XUV luminosity L$_{{\mathrm{EUV}}}$ [erg $s^{-1}$]', fontsize=15)
...
plt.savefig(f'/Users/emmapostolec/Documents/PHD/SCIENCE/CODES/ZEPHYRUS/plots/test_mors/Mors_tracks_Leuv_Omega_{omega}.png',dpi=180)
plt.show()
