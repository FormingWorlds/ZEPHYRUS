...
- Units are SI: `EL_escape` takes m, kg and W m-2 and returns kg s-1; MORS luminosities in erg s-1 become a flux by dividing by `4 pi a**2` with `a` in cm, then `ergcm2stoWm2`.
