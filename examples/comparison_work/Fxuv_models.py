...
incident_xuv_flux_Johnstone_G5, luminosity_Johnstone= vectorized_Fxuv_Johnstone(time_simulation, au2m, 'G5')
incident_xuv_flux_Johnstone_M1, luminosity_Johnstone= vectorized_Fxuv_Johnstone(time_simulation, au2m, 'M1')
incident_xuv_flux_Johnstone_K5, luminosity_Johnstone= vectorized_Fxuv_Johnstone(time_simulation, au2m, 'K5')
incident_xuv_flux_Johnstone_Sun, luminosity_Johnstone= vectorized_Fxuv_Johnstone(time_simulation, au2m, 'Sun')
...
plt.loglog(time_simulation_Myr,incident_xuv_flux_Johnstone_G5/ergcm2stoWm2,color = 'yellow', label = 'XUV model 2 : IsoFATE : Johnstone+2021 (G5 star, 1.0 Msun, 50 Percentile)')
plt.loglog(time_simulation_Myr,incident_xuv_flux_Johnstone_K5/ergcm2stoWm2,color = 'khaki', label = 'XUV model 2 : IsoFATE : Johnstone+2021 (K5 star, 0.7 Msun, 50 Percentile)')
plt.loglog(time_simulation_Myr,incident_xuv_flux_Johnstone_M1/ergcm2stoWm2,color = 'darkkhaki', label = 'XUV model 2 : IsoFATE : Johnstone+2021 (M1 star, 1.0 Msun, 50 Percentile)')
plt.loglog(time_simulation_Myr,incident_xuv_flux_Johnstone_Sun/ergcm2stoWm2,color = 'palegoldenrod', label = 'XUV model 2 : IsoFATE : Johnstone+2021 (Sun star, 1.0 Msun, 1.0 OmegaSun)')
