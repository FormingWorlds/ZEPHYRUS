...
axs[2].plot(t_a_isofate*s2yr, (N2_a_isofate[0]/N1_a_isofate[0])/StoH_protosolar, linestyle='-', label=r'IsoFATE', color='maroon')
axs[2].plot(t_a_zephyrus*s2yr, (N2_a_zephyrus[0]/N1_a_zephyrus[0])/StoH_protosolar, linestyle=':', label=r'Zephyrus', color='maroon', linewidth=2)
